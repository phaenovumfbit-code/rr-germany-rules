...
\title{\tagYear\a-MAZE-ing Challenge}
...
\begin{enumerate}
	...
	\item Sollten weniger als 8 Teams innerhalb der Altersgruppe zur Verfügung stehen, kann die Veranstaltungsleitung einen alternativen Turnierplan (z.B Turnier nach Rangliste) festlegen.
\end{enumerate}
\tournamentScoring
\combinedTournament
\end{document}
